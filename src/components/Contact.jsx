    ...
    <motion.div ref={ref} initial={{ opacity: 0}} animate={controls} id='contact' className='flex flex-col gap-12 py-24 contact_section xs:px-12'>
        ...
        <div className='flex flex-col w-full gap-5'>
          <FormControl className='flex gap-10 xs:flex-col xs:gap-5 sm:flex-row sm:gap-10'>
            <Input type='text' placeholder='Your Name' focusBorderColor='#fff' _placeholder={{ color: '#fff' }} size='lg' bg='#1f2235' isInvalid
    errorBorderColor='#1f2235'/>
            <Input type='email' placeholder='Your Email' focusBorderColor='#fff' _placeholder={{ color: '#fff' }} size='lg' bg='#1f2235' isInvalid
    errorBorderColor='#1f2235'/>
          </FormControl>
          <FormControl className='flex w-full'>
            <Input type='text' placeholder='Your Subject' focusBorderColor='#fff' _placeholder={{ color: '#fff' }} size='lg' bg='#1f2235' isInvalid
    errorBorderColor='#1f2235'/>
          </FormControl>
          <FormControl className='flex w-full'>
            <Textarea type='text' placeholder='Your Message' focusBorderColor='#fff' _placeholder={{ color: '#fff' }} size='lg' height={40} bg='#1f2235' isInvalid
    errorBorderColor='#1f2235'/>
          </FormControl>
